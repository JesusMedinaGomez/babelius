    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.classification', verbose_name='Clasificación')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('drawer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.drawer', verbose_name='Cajón')),
                ('genre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.gender', verbose_name='Género')),
            ],
        ),
        migrations.AddField(
            model_name='drawer',
            name='shelf',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.shelf', verbose_name='Estante'),
        ),
    ]
